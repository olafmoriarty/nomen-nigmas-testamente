...
=== inventory
Lommene mine er tomme. #style:narrative
->->
...
Kva vil eg gjera? #style:narrative #person:
+ [Dra til ein annan stad] ->map
+ [Sjekk lommene] ->inventory->kontoret

= first
Det var ein grå og regnfull formiddag. Den typen grå og regnfull du berre finner i Oslo i april. #style:narrative
Utanfor det dårleg isolerte kontorvindauget var gata allereie fylt av bilar på veg til påskefiellet, og 
